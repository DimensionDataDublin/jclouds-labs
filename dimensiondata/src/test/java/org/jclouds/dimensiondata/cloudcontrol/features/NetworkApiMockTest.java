...
public class NetworkApiMockTest extends BaseAccountAwareCloudControlMockTest {
   ...
   public void testListVlansWithNetworkDomainIdAndName() throws Exception {
      server.enqueue(jsonResponse("/vlans.json"));
      api.getNetworkApi().listVlansWithNetworkDomainIdAndName("testNetworkDomainId", "testName").concat();
      assertSent(GET, "/caas/2.4/6ac1e746-b1ea-4da5-a24e-caf1a978789d/network/vlan"
            + "?networkDomainId=testNetworkDomainId&name=testName");
   }

   public void testListVlansWithNetworkDomainIdAndName_404() throws Exception {
      server.enqueue(response404());
      api.getNetworkApi().listVlansWithNetworkDomainIdAndName("testNetworkDomainId", "testName").concat();
      assertSent(GET, "/caas/2.4/6ac1e746-b1ea-4da5-a24e-caf1a978789d/network/vlan"
            + "?networkDomainId=testNetworkDomainId&name=testName");
