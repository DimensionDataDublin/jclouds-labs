...
@Test(groups = "unit", testName = "DimensionDataCloudControlResponseUtilsTest", singleThreaded = true)
public class DimensionDataCloudControlResponseUtilsTest {
   ...
   public void testTryFindPropertyValue() {
      ...
      Assert.assertEquals(DimensionDataCloudControlResponseUtils.tryFindInfoPropertyValue(response, "propertyName1"),
            "propertyValue1");
      Assert.assertEquals(DimensionDataCloudControlResponseUtils.tryFindInfoPropertyValue(response, "propertyName2"),
            "propertyValue2");
   }
   ...
   public void testTryFindPropertyValue_PropertyNotFound() {
      ...
      DimensionDataCloudControlResponseUtils.tryFindInfoPropertyValue(response, "noProperty");
   }
}
