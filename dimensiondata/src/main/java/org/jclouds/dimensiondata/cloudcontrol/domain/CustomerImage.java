...
public abstract class CustomerImage extends BaseImage {
   ...
   public abstract static class Builder {
      ...
      public abstract CustomerImage.Builder softwareLabels(List<Object> softwareLabels);
      ...
      public abstract CustomerImage.Builder scsiControllers(List<ScsiController> scsiControllers);

      public abstract CustomerImage.Builder sataControllers(List<SataController> sataControllers);

      public abstract CustomerImage.Builder ideControllers(List<IdeController> ideControllers);

      public abstract CustomerImage.Builder floppies(List<Floppy> floppies);
