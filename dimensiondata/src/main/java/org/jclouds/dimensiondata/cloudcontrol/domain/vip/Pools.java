...
public class Pools extends PaginatedCollection<Pool> {
   ...
   @ConstructorProperties({ "pool", "pageNumber", "pageCount", "totalCount", "pageSize" })
   public Pools(List<Pool> content, Integer pageNumber, Integer pageCount, Integer totalCount, Integer pageSize) {
