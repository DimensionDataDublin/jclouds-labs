...
public abstract class Server {
   ...
   public static Server create(String id, String name, String description, String datacenterId, State state,
         String sourceImageId, String createTime, Boolean started, Boolean deployed, OperatingSystem operatingSystem,
         CPU cpu, Integer memoryGb, List<Disk> disks, NetworkInfo networkInfo, List<Object> softwareLabels,
