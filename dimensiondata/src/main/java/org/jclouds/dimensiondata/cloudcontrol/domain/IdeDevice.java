...
public abstract class IdeDevice {
   ...
   public abstract static class Builder {
      ...
      public abstract IdeDevice.Builder slot(String slot);
   ...
   public static IdeDevice create(String id, String slot, String type, int sizeGb, String fileName, State state) {
