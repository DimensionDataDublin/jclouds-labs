...
public abstract class Tag {
   ...
   @SerializedNames({ "assetType", "assetId", "assetName", "datacenterId", "tagKeyId", "tagKeyName", "value",
         "valueRequired", "displayOnReport" })
   public static Tag create(String assetType, String assetId, String assetName, String datacenterId, String tagKeyId,
         String tagKeyName, String value, Boolean valueRequired, Boolean displayOnReport) {
      return builder().assetType(assetType).assetId(assetId).assetName(assetName).datacenterId(datacenterId)
            .tagKeyId(tagKeyId).tagKeyName(tagKeyName).value(value).valueRequired(valueRequired)
